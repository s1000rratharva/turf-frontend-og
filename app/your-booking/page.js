  ...
  useEffect(() => {
    onAuthStateChanged(auth, async (user) => {
      ...
      try {
        ...
        const allBookings = [...cricketBookings, ...footballBookings].sort(
          (a, b) => {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Manage and view your upcoming and past bookings
          </p>
        </div>
            ...
            <div className="flex space-x-1">
              {[
                ...
                },
                {
                  ...
                  label: "Past",
                  count: bookings.filter(
                    (b) => getBookingStatus(b).status === "Completed"
                  ).length,
                },
              ].map((tab) => (
                <button
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600">
                              ₹{booking.amountPaid || 1500} •{" "}
                              {booking.slotsBooked || 1} hour
                              {booking.slotsBooked > 1 ? "s" : ""}
                            </p>
                          </div>
                        </div>
                          ...
                          <div className="flex-1">
                            ...
                            booking.selectedSlots.length > 0 ? (
                              <div className="space-y-1">
                                ...
                                {booking.selectedSlots.length > 1 && (
                                  <p className="text-xs text-green-600 font-medium">
                                    {booking.selectedSlots.length} slots booked
                                  </p>
                                )}
                              </div>
                            ) : (
